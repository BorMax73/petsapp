...
public class CatsViewModel : BaseViewModel, IPageViewModel
{
	public string Name { get; } = "Коти";
	...
	public CatsViewModel(PageSelectorViewModel pageSelector)
	{
	...
	{
		Pets.Clear();
		var pets = _petRepository.GetByType("cat");
