...
public class AnotherPetsViewModel : BaseViewModel, IPageViewModel
{
	public string Name { get; } = "Інше";
	...
	public AnotherPetsViewModel(PageSelectorViewModel pageSelector)
	{
	...
	{
		Pets.Clear();
		var pets = _petRepository.GetByType("another");
