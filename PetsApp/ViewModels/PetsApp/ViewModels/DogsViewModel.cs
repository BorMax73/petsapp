...
public class DogsViewModel : BaseViewModel, IPageViewModel
{
	public string Name { get; } = "Собаки";
	...
	public DogsViewModel(PageSelectorViewModel pageSelector)
	{
	...
	{
		Pets.Clear();
		var pets = _petRepository.GetByType("dog");
